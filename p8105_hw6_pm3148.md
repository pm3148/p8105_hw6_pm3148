...
-   One using head circumference, length, sex, and all interactions
    (including the three-way interaction) between these - `model_comp_2`
...
```
    ...
    ## 
    ## Call:
    ## lm(formula = bwt ~ bhead * blength + bhead * blength * babysex + 
    ##     blength * babysex + bhead * babysex, data = birth_cln)
    ## 
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
